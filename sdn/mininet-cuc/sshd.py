...
def connectToRootNS( network, switch, ip, routes ):
    ...
    for route in routes:
        ...
        root.cmd( 'route add -net ' + route + ' gw ' + ip )
        print ("add route %s" % route )
...
def sshd( network, cmd='/usr/sbin/sshd', opts='-D',
    ...
    print ( '# 如果ssh连接中断, 请手工设置路由')
    print ( 'ifconfig root-eth0 10.0.0.254 netmask 255.255.255.0')
    print ( 'route add -net 10.0.0.0/24 gw 10.0.0.254')
    print()
