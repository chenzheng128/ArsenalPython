...
from .official import WxApplication as BaseApplication, DtBaseApi
...
class DingDingApi(DtBaseApi):

    #API_PREFIX = 'https://oapi.dingding.com/'
    #API_PREFIX = 'https://oapi.dingding.com/apiagent'
    API_PREFIX = 'https://debug.dingtalk.com/apiagent/'


    def __init__(self, appid, appsecret, api_entry=None):
        super(DingDingApi, self).__init__(appid, appsecret, api_entry)
    ...
    def access_token(self):
        ...
        if not self._access_token:
            ...
            if not err:
                ...
                self.expires_in = time.time() + 1200 # token['expires_in']
    ...
    def get_access_token(self, url=None, **kwargs):
        ...
        rsp = requests.get(url or self.api_entry + 'gettoken',
                           params=params,
                           verify=False)
    ...
    def add_user(self, userid, name, department=None, position=None,
        ...
        return self._post('user/create', params)
    ...
    def update_user(self, userid, name, department=None, position=None,
        ...
        return self._post('user/update', params)

    def delete_user(self, userid):
        return self._get('user/delete',
    ...
    def upload_media(self, mtype, file_path=None, file_content=None):
        return super(DingDingApi, self).upload_media(
    ...
    def download_media(self, media_id, to_path):
        return super(DingDingApi, self).download_media(
            media_id, to_path, 'media/get')
    ...
    def create_menu(self, menus, agentid):
        return self._post('menu/create?agentid=%s' % agentid,
                          repr(menus), ctype='text')

    def get_menu(self, agentid):
        return self._get('menu/get', {'agentid': agentid})

    def delete_menu(self, agentid):
        return self._get('menu/delete', {'agentid': agentid})
    ...
    def get_user_info(self, agentid, code):
        return self._get('user/getuserinfo',
